...
const UserNavbar = ({ userName }) => {
  ...
  return (
    <header className="sticky top-0 z-20 flex items-center justify-between border-b border-slate-200 dark:border-[#23482f] bg-white/80 dark:bg-[#102216]/80 backdrop-blur-md px-8 py-4">
      ...
      <div className="flex items-center gap-6">
        <div className="relative w-64 hidden md:block">
          ...
          <input className="w-full pl-10 pr-4 py-2 rounded-xl border-none bg-slate-100 dark:bg-[#23482f] text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-[#92c9a4] text-sm focus:ring-2 focus:ring-[#13ec5b80] outline-none transition-all" placeholder="Find a skill..." type="text"/>
        </div>
