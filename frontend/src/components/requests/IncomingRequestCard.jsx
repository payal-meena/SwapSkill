...
//   try {
//     // 1. Request bhejo (Saamne wale ki ID receiver mein jayegi)
//     await requestService.sendRequest({ receiver: requester._id });
    
//     // 2. Refresh call karo taaki UI update ho jaye (Status pending dikhne lage)
//     refresh(); 
    
//     // Optional: User ko feedback do
//     console.log("Request re-sent successfully");
//   } catch (err) {
//     console.error("Connect failed:", err);
//     alert(err.response?.data?.message || "Failed to re-connect");
//   }
// };
...
//   {/* CASE 2: ACCEPTED - Using Theme Green but with Outline/Solid mix */}
//   {status === 'accepted' && (
//     <>
//       <button 
//         onClick={handleMessageClick} 
//         className="flex items-center gap-2 px-8 py-3 bg-[#193322] border border-[#13ec5b]/50 text-[#13ec5b] font-bold rounded-2xl hover:bg-[#13ec5b] hover:text-[#102216] transition-all group"
//       >
//         <span className="material-symbols-outlined text-[18px] group-hover:fill-current">send</span> 
//         Message
//       </button>
//       <button
//         onClick={() => handleAction('remove')}
...
//   {/* CASE 3: REJECTED - Subtle Gray-Green Theme */}
//   {status === 'rejected' && (
//     <>
//       <button 
//         onClick={handleConnect} 
//         className="px-8 py-3 bg-transparent border border-[#23482f] text-[#92c9a4] font-bold rounded-2xl hover:border-[#13ec5b] hover:text-[#13ec5b] transition-all flex items-center gap-2"
//       >
...
//       <button
//         onClick={() => handleAction('remove')}
//         className="w-12 h-12 flex items-center justify-center bg-[#112217] border border-[#23482f] text-slate-600 hover:text-red-500 rounded-2xl transition-all"
//       >
